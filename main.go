//go:generate bash -c "mkdir -p codegen && go run github.com/deepmap/oapi-codegen/cmd/oapi-codegen@v1.16.2 -generate types,server,spec -package codegen api/firewall/openapi.yaml > codegen/firewall_api.go"
